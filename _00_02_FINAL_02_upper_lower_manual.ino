// CODE TO ARDUINO MEGA2560 FOR AUTO HIGH AND RΟΤΑΤΙΟΝ OF THE HEAD OF MF760 COMPINE HARVESTER
// THERE IS 5 POINTS TO MEASURE THE HIGH OF THE HEAD (WITH 3 SWITCHES IN EVERY POINT) 
// THE FIRST OF THE 3 SWITCHES SEE THE HIGH LEVEL THE OTHER THE LOW LEVEL AND THE THIRD ONE IS TO GIVE COMMAND TO THE SYSTEM TO UP THE HEAD IMEDIATELY
// (THE HEAD IS VERY LOW AND NEEDS TO GO UP)
// I NEED TO CLEAR THE CODE...
